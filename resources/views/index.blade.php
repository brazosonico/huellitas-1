...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/templatemo-glossy-touch.css') }}">
...
<body>
        ...
        <div class="container">
            <div class="content-wrapper">
                <section class="hero glass">
                    ...
                    <img src="{{ asset('images/templatemo-futuristic-girl.jpg') }}" alt="Modern Technology Interaction" />
                    </div>
    ...
    <script src="{{ asset('js/templatemo-glossy-touch.js') }}"></script>
</body>
</html>